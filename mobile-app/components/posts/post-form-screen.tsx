...
type PostFormScreenProps = {
    ...
    backIcon?: keyof typeof Ionicons.glyphMap | keyof typeof Feather.glyphMap;
    backIconLibrary?: 'ionicons' | 'feather';
...
export function PostFormScreen({
    ...
    const backButtonIcon = backIconLibrary === 'ionicons'
        ? <Ionicons name={backIcon as keyof typeof Ionicons.glyphMap} size={22} color="#1F2937"/>
        : <Feather name={backIcon as keyof typeof Feather.glyphMap} size={22} color="#1F2937"/>;
                    ...
                    <View style={styles.formCard}>
                        ...
                        <View style={styles.summaryCard}>
                            <View style={styles.summaryHeader}>
                                ...
                                <View style={styles.summarySwitchWrap}>
                                    <Switch
                                        value={form.pinned}
