                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.sectionCard}>
                            ...
                            <Pressable style={styles.securityActionButton} onPress={openEditModal}>
                                <View style={styles.securityActionLeft}>
                                    <View style={styles.securityActionIcon}>
                                        <Ionicons name="key-outline" size={18} color="#3F7FC4"/>
                                    </View>

                                    <Text style={styles.securityActionText}>Ændr kodeord</Text>
                                </View>
                    ...
                    <View style={styles.actionGroup}>
                        ...
                        <Pressable style={styles.heroLogoutButton} onPress={handleLogout}>
                            <Text style={styles.heroLogoutButtonText}>Log ud</Text>
                        </Pressable>
                    </View>

                    <View style={styles.deleteProfileWrap}>
